...
model = dict(
    type='RetinaMask',
    pretrained='model_zoo/retinanet_r50_fpn_1x_20181125-7b0c2548.pth',#'retinanet_r50_fpn_1x_20181125-7b0c2548.pth',
    backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
log_level = 'INFO'
load_from = None
resume_from = 'model_zoo/retinanet_r50_fpn_1x_20181125-7b0c2548.pth'#f'{work_dir}/latest.pth'
workflow = [('train', 1)]
