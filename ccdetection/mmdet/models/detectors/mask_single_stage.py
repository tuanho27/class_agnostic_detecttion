...
class MaskSingleStateDetector(BaseDetector):
	...
	"""
	def __init__(self, backbone, neck=None, bbox_head=None, mask_roi_extractor=None, mask_head=None, train_cfg=None, test_cfg=None, pretrained=None):
	...
	def simple_test(self, img, img_meta, proposals=None, rescale=False):
		...
		det_bboxes, det_labels = bbox_list
