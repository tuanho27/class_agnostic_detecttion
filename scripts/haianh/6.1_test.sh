...
CHECKPOINT_FILE='model_zoo/fcos_r50_caffe_fpn_gn_2x_4gpu_20190516_-93484354.pth'
...
$PYTHON -m torch.distributed.launch --nproc_per_node=$GPUS \
	ccdetection/tools/test.py ${CONFIG_FILE} ${CHECKPOINT_FILE} --launcher pytorch --out ${RESULT_FILE} --eval bbox 
